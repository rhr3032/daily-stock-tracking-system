...
function formatOrder(order: { id: string; date: string; productId: string; quantity: number; createdAt: Date; product: { name: string } }) {
  return { ...order, productName: order.product.name };
}

function formatSale(sale: { id: string; date: string; productId: string; quantity: number; amount: number; createdAt: Date; product: { name: string } }) {
  return { ...sale, productName: sale.product.name };
}

function formatDispatch(dispatch: { id: string; date: string; productId: string; quantity: number; createdAt: Date; product: { name: string } }) {
  return { ...dispatch, productName: dispatch.product.name };
}

function formatReturn(entry: { id: string; date: string; productId: string; quantity: number; amount: number; createdAt: Date; product: { name: string } }) {
